 ...
 */
public class WaveAnimateView extends RelativeLayout {
     ...
     */
    public WaveAnimateView(Context context, AttributeSet attrs) {
     ...
     *                     for defaults.
     */
    public WaveAnimateView(Context context, AttributeSet attrs, int defStyleAttr) {
