package com.shahrdari.utils.backboard;
...
import com.shahrdari.utils.backboard.imitator.EventImitator;
import com.shahrdari.utils.backboard.imitator.Imitator;
import com.shahrdari.utils.backboard.imitator.MotionImitator;
...
public final class Actor {
    ...
    public static class Builder {
        ...
        /**
         * @param onTouchListener a touch listener to pass touch events to
        ...
        /**
         * @param spring     the underlying {@link Spring}.
         ...
         * @param springListener a spring listener to attach to the spring
         * @return this builder for chaining
         */
        @NonNull
        public Builder addMotion(@NonNull final Spring spring, final int trackStrategy, final int followStrategy,
        ...
        /**
         * @param spring        the underlying {@link Spring}.
         * @param eventImitator maps an event to a {@link Spring}
         * @param performers    map the {@link Spring} to a
         *                      {@link View}
        ...
        /**
         * @param motionImitator maps an event to a {@link Spring}
         * @param viewProperty   the {@link View} property to animate
        ...
        /**
         * @return flag to tell the attached {@link View.OnTouchListener} to call
