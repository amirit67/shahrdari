package com.shahrdari.utils.backboard.imitator;

import android.view.MotionEvent;

import androidx.annotation.NonNull;

import com.shahrdari.utils.backboard.MotionProperty;
 ...
 * user is not dragging it. It copies the {@link SpringConfig} in
 * {@link #setSpring(Spring)} to use when the user is dragging.
 * <p>
...
public class InertialImitator extends ConstrainedMotionImitator implements SpringListener {
    ...
    /**
     * The friction (in {@link SpringConfig}) to use when moving freely.
     */
    public static final float DEFAULT_FRICTION = 1.0f;

    /**
     * The {@link SpringConfig} to use when moving freely.
     */
    public static final SpringConfig SPRING_CONFIG_FRICTION = new SpringConfig(0, DEFAULT_FRICTION);

    /**
     * Used to convert {@link Spring#getVelocity()} to the units needed by
    ...
    /**
     * Sets the {@link Spring} that this imitator should use. This class
     * attaches itself as a {@link SpringListener} and stores the
     * {@link SpringConfig} to use when the user is dragging.
     *
