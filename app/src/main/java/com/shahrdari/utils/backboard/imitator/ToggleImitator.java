...
/**
 * Toggle between two {@link Spring} states depending on whether or not the user is touching the
 * screen. When the user presses, {@link #constrain(MotionEvent)} is called and the active value is set.
 * When the user releases, {@link #release(MotionEvent)} is called and the rest value is set.
 * <p>
