...
/**
 * Maps a {@link MotionEvent} to a {@link Spring},
...
public abstract class EventImitator extends Imitator {
    ...
    /**
     * Maps a user's motion to {@link View} via a {@link Spring}.
     *
     * @param view  the view to perturb.
     * @param event the motion to imitate.
     */
