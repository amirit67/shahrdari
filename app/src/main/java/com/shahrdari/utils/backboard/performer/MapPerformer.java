...
import com.shahrdari.utils.backboard.rebound.SpringUtil;

/**
 * Maps the motion of a {@link Spring} to a
...
public class MapPerformer extends Performer {
     ...
     * @param target   the view to modify.
     * @param property the view property to modify.
     * @param start    the minimum value for the view property range.
     * @param end      the maximum value for the view property range.
     */
     ...
     * @param target       the view to modify.
     * @param property     the view property to modify.
     * @param initialStart the minimum value for the spring domain.
     * @param initialEnd   the maximum value for the spring domain.
     * @param start        the minimum value for the view property range.
     * @param end          the maximum value for the view property range.
     */
